...
AlloySmelter.addRecipe(<ProjRed|Core:projectred.core.part:13> , <ore:plateSilicon>, <minecraft:redstone> * 8, 20, 3);
AlloySmelter.addRecipe(<ProjRed|Core:projectred.core.part:14>, <ore:plateSilicon>, <minecraft:glowstone_dust> * 8, 20, 3);
Assembler.addRecipe(<ProjRed|Core:projectred.core.part> * 2, <minecraft:stone>, <ore:plateSteel>, 80, 4);//**Integrated Circuit:3
