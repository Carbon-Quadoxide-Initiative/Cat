...
game.setLocalization("gp.research_page.GOLEMTHAUMIUM", "Thaumium golems are tougher than their iron counterpart, and is capable of getting 2 upgrades.<BR>They are highly resistant to magic damage.<BR>Their weight causes them to sink in water, and they move quite slowly.");
