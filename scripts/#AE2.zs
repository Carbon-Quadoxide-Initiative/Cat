...
recipes.addShaped(<appliedenergistics2:item.ItemMultiPart:180>,
 [[null, <ore:plateGlowstone>, null],
  [<ore:plateAluminium>, <ore:plateRedAlloy>, null], //**MONITOR
  [null, <ore:plateGlowstone>, null]]);
...
recipes.addShaped(<appliedenergistics2:tile.BlockCharger>,
 [[<ore:plateAluminium>, <appliedenergistics2:item.ItemMultiMaterial:7>, <ore:plateAluminium>],
  [<ore:cableGt01AnyCopper>, <ore:blockIngotAnySteel>, <ore:cableGt01AnyCopper>], //**MV HULL
  [<ore:plateAluminium>, <appliedenergistics2:item.ItemMultiMaterial:7>, <ore:plateAluminium>]]);
 
//ME Drive
recipes.addShaped(<appliedenergistics2:tile.BlockDrive>,
 [[<ore:plateAluminium>, <appliedenergistics2:item.ItemMultiMaterial:24>, <ore:plateAluminium>],
  [<appliedenergistics2:item.ItemMultiPart:16>, <ore:blockIngotAnySteel>, <appliedenergistics2:item.ItemMultiPart:16>], //**MV HULL
  [<ore:plateAluminium>, <appliedenergistics2:item.ItemMultiMaterial:24>, <ore:plateAluminium>]]);
 
//Vibration Chamber
recipes.addShaped(<appliedenergisticscas:tile.BlockVibrationChamber>,
 [[<ore:plateAluminium>, <ore:plateAluminium>, <ore:plateAluminium>],
  [<ore:plateAluminium>, <ore:ingotQuintupleAluminium>, <ore:plateAluminium>], //**ADVANCED ELECTRIC FURNACE
...
recipes.addShaped(<appliedenergistics2:tile.BlockCondenser>,
 [[<ore:plateAluminium>, <ore:ingotQuintupleAluminium>, <ore:plateAluminium>], //**MV PISTON
  [<ore:ingotQuintupleAluminium>, <ore:blockIngotAnySteel>, <ore:ingotQuintupleAluminium>], //**MV HULL MV PISTON
  [<ore:plateAluminium>, <ore:ingotQuintupleAluminium>, <ore:plateAluminium>]]); //**MV PISTON
 
//Cell Workbench
recipes.addShaped(<appliedenergistics2:tile.BlockCellWorkbench>,
 [[<minecraft:wool>, null, <minecraft:wool>], //**MONITOR
...
recipes.addShaped(<appliedenergistics2:tile.BlockEnergyCell>,
 [[<ore:plateCertusQuartz>, <appliedenergistics2:item.ItemMultiMaterial:8>, <ore:plateCertusQuartz>],
  [<appliedenergistics2:item.ItemMultiMaterial:8>, <ore:ingotQuintupleAluminium>, <appliedenergistics2:item.ItemMultiMaterial:8>], //**16 MV BUFFER
  [<ore:plateCertusQuartz>, <appliedenergistics2:item.ItemMultiMaterial:8>, <ore:plateCertusQuartz>]]);
...
recipes.addShaped(<appliedenergistics2:tile.BlockQuartzTorch>,
 [[<ore:gemCertusQuartz>, <ore:stickAluminium>, null],
  [null, null, null],
  [null, null, null]]);
...
recipes.addShaped(<appliedenergistics2:tile.BlockController>,
 [[<ore:blockIngotAnySteel>, null, <ore:blockIngotAnySteel>], //**MONITOR Solid Steel Machine Casing
  ...
  [<ore:blockIngotAnySteel>, <appliedenergistics2:item.ItemMultiMaterial:7>, <ore:blockIngotAnySteel>]]); //**Solid Steel Machine Casing
